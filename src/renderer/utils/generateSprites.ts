 ...
 * 生成像素宠物精灵图占位资源
 * 运行方式:
 *   npx ts-node --esm src/renderer/utils/generateSprites.ts
 *   或者先编译再运行
 */
...
function generateCatSpriteData(type: string): number[][][] {
...
function generateSprite(type: string, filename: string) {
